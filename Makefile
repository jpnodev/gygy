...
$(MAIN_EXEC): debug.o hachage.o memory.o parser.o cpu.o main.o addressing.o
	$(CC) -o $@ $^ $(LDFLAGS)
...
clean:
	rm -f *.o $(MAIN_EXEC) $(TEST_HACHAGE_EXEC) $(TEST_MEMORY_EXEC) $(TEST_PARSER_EXEC) $(TEST_CPU_EXEC)
